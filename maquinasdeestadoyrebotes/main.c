...
static fsm_trans_t semp[] = {
	{ ESTADO_UNO, button_pressed, ESTADO_DOS,	 func_uno	},
	{ ESTADO_UNO,	 timer_finished, ESTADO_UNO,	func_tres },
	{ ESTADO_DOS,	cuenta, ESTADO_TRES,	func_dos	 },
	{ ESTADO_TRES,	timer_finished, ESTADO_UNO, finish },
	{-1, NULL, -1, NULL },
	};
...
/*!
   \todo add getchar or scanf, change add key to exit , add user driven event
   remove timer
*/
	while (1) {
